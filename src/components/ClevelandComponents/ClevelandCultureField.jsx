const ClevelandCultureFields = ({setFilterInputs,cultureField, setCultureField,cultureFieldError,setCultureFieldError,disabled})=>{
    ...
    return(
        ...
        <input id='culture'type="text" className={`border px-3 py-2 rounded w-full h-10 md:w-auto text-sm ${cultureFieldError ? "border-red-500" : "border-gray-300"}`} placeholder="Search by location..."
